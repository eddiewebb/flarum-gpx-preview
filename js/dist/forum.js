...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_Post__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'oncreate', function (isInitialized) {
    if (isInitialized) return;
    var postId = this.attrs.post.id(); //console.log(this.$('.gpxFile').data('fofUploadDownloadUuid'));
